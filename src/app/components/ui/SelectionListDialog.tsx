...
export const SelectionListDialog: React.FC<SelectionListDialogProps> = ({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={title} noScroll>
            ...
            >
                <div className="flex-1 min-h-0 px-3 pt-0 flex flex-col">
                    <div className="ui-toolbar flex items-center justify-between gap-2 shrink-0 -mx-3 px-3">
                    ...
                    <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar pr-1 mt-2">
