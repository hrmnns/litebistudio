...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, headerActions, children, noScroll, variant = 'default' }) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            {/* Content */}
            <div className={cn(
                "relative bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 shadow-2xl w-full max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-200 z-10 overflow-hidden",
                ...
                <div className={cn(
                    ...
                    <h3 className={cn(
                        ...
                        variant === 'dialog' ? "text-sm font-semibold" : "text-xl font-bold"
                    )}>
                        {title}
                    </h3>
