        ...
        <>
            ...
            >
                <div className={`flex items-center gap-2.5 ${isCollapsed ? 'md:justify-center' : ''}`}>
                    ...
                    <span className={`text-xs font-bold text-slate-700 dark:text-slate-200 transition-all duration-300 ${isCollapsed ? 'md:opacity-0 md:w-0 overflow-hidden' : 'opacity-100'}`}>System Status</span>
                    {!isCollapsed && (
